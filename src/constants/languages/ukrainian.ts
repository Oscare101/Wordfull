...
const ukrainian = {
  ...
  AccuracyEasy: 'Точність у легкому режимі',
  AccuracyHard: 'Точність у складному режимі',
  AccuracyStamina: 'Точність у режимі витривалості',
  ...
  LearningScreenDescription:
    "Ви можете використовувати цей екран, щоб краще зрозуміти функціонал застосунку або навчитися методам запам'ятовування. Тут ви знайдете пояснення ігрових режимів та поради для покращення ваших навичок запам'ятовування.",
