...
interface SettingsContextValue {
  ...
  setSelectedWordPackId: (wordPackId: string | null) => Promise<void>;
...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
  ...
  const setSelectedWordPackId = useCallback(
    async (wordPackId: string | null) => {
      try {
  ...
  const value = useMemo<SettingsContextValue>(() => {
    return {
      ...
      selectedWordPackId: settings?.selectedWordPackId ?? null,
      isLoading,
